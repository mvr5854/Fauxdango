...
class DatastoreTest {
    ...
    @Test
    void getMovieById__pass_validId_return_correctMovie() {
        Movie movie = Datastore.getMovieById(1);
        assertEquals("Top Gun", movie.getTitle());
    }

    @Test
    void getMovieById__pass_invalidId_return_null() {
    ...
    @Test
    void getActorById__pass_validId_return_correctActor() {
    ...
    @Test
    void getActorById__pass_invalidId_return_null() {
    ...
    @Test
    void getAuditoriumById__pass_validId_return_correctAuditorium() {
        Auditorium auditorium = Datastore.getAuditoriumById(1);
        assertEquals("1", auditorium.toString());
    }

    @Test
    void getAuditoriumById__pass_invalidId_return_null() {
    ...
    @Test
    void searchTheatersByZipcode__pass_unmatchedZipcode_return_emptyList() {
        List<Theater> foundTheaters = Datastore.searchTheatersByZipcode("12345");
        assertTrue(foundTheaters.isEmpty());
    }

    @Test
    void searchTheatersByZipcode__pass_matchedZipcode_return_correctTheaters() {
    ...
    @Test
    void getShowingById__pass_validId_return_correctShowing() {
        Showing showing = Datastore.getShowingById(1);
        assertTrue(showing.toString().contains("Top Gun"));
    }

    @Test
    void getShowingById__pass_invalidId_return_null() {
